...
def train(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
    ...
    for class_dir in os.listdir(train_dir):
        ...
        for img_path in image_files_in_folder(os.path.join(train_dir, class_dir)):
            count = count + 1
            print('Image ' + str(count) + ' - ' + img_path)
...
if __name__ == "__main__":
    ...
    # classifier = train("../test_images/train",
    #                    model_save_path="models/trained_knn_model.clf", n_neighbors=2)
    ...
    for image_file in os.listdir("../test_images/test")[:2]:
        total = total + 1
        full_file_path = os.path.join("../test_images/test", image_file)
        ...
        # model instance
        predictions = predict(
            full_file_path, model_path="models/trained_model.clf")
        ...
        show_prediction_labels_on_image(os.path.join(
            "../test_images/test", image_file), predictions)

    print("----------")
    print("  Total images: {}".format(str(total)))
    print("  Correct:      {}".format(str(correct)))
    print("  Incorrect:    {}".format(str(incorrect)))
    print("----------")
